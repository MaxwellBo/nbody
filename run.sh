...
echo "./nbody $numTimeSteps $outputInterval $deltaT inputs/$1 > outputs/$name.data"
make && time ./nbody $numTimeSteps $outputInterval $deltaT  "inputs/$1" > "outputs/$name.data" && echo "Exported data to ./outputs/$name.data"
